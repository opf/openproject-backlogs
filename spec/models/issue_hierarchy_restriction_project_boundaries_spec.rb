...
describe WorkPackage, 'parent-child relationships between backlogs stories and backlogs tasks', type: :model do
  context 'are prohibited if they span project boundaries' do
