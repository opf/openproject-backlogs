  ...
  describe 'Class Methods' do
    describe '#displayed_left' do
      describe 'WITH display set to left' do
        before(:each) do
          sprint.version_settings = [
            FactoryGirl.build(:version_setting, project: project,
      ...
      describe 'WITH a version setting defined for another project' do
        before(:each) do
          ...
          sprint.version_settings = [
            FactoryGirl.build(:version_setting, project: another_project,
    ...
    describe '#order_by_date' do
      before(:each) do
        @sprint1 = FactoryGirl.create(:sprint, name: 'sprint1',
                                               project: project,
                                               start_date: Time.zone.today + 2.days)
        @sprint2 = FactoryGirl.create(:sprint, name: 'sprint2',
                                               project: project,
                                               start_date: Time.zone.today + 1.day,
                                               effective_date: Time.zone.today + 3.days)
        @sprint3 = FactoryGirl.create(:sprint, name: 'sprint3',
                                               project: project,
                                               start_date: Time.zone.today + 1.day,
                                               effective_date: Time.zone.today + 2.days)
      end
    ...
    describe '#apply_to' do
      ...
      describe 'WITH the version beeing shared system wide' do
        before(:each) do
          @version = FactoryGirl.create(:sprint, name: 'systemwide',
      ...
      describe 'WITH the version beeing shared from a parent project' do
        before(:each) do
          ...
          @version = FactoryGirl.create(:sprint, name: 'descended',
                                                 project: @other_project,
                                                 sharing: 'descendants')
        end
      ...
      describe 'WITH the version beeing shared within the tree' do
        before(:each) do
          ...
          @version = FactoryGirl.create(:sprint, name: 'treed',
                                                 project: @other_project,
                                                 sharing: 'tree')
        end
      ...
      describe 'WITH the version beeing shared within the tree' do
        before(:each) do
          ...
          @version = FactoryGirl.create(:sprint, name: 'hierar',
                                                 project: @descendant_project,
                                                 sharing: 'hierarchy')
        end
